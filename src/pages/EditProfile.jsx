...
const EditProfile = () => {
  ...
  const handleSubmit1 = async () => {
    ...
    try {
      ...
      var templateParams = {
        ...
        text: 'We received a request to delete your account on SocialApp. This decision may be irreversible.',
  ...
  const handleSubmit2 = async () => {
    ...
    try {
      ...
      var templateParams = {
        ...
        name: user.name,
        email: userEmail.email,
        text: 'We received a request to confirm the email for your SocialApp account. This decision may be irreversible.',
  ...
  return (
    <aside id="EditProfile" className="Container noheaderMenu">
      ...
      <Helmet>
        <title>{t("Editar perfil")} / SocialApp</title>
      </Helmet>
