        ...
        <div className="button2 mb-10">
          <Link to="/SocialApp">
            <Button className="bg-2">
              <span>{t("Veja nosso perfil")} <b>@SocialApp</b></span>
        ...
        <div className="Footer">
          ...
          <div className="linksFooter">
            <div className="linkSocial">
              <Link to="/SocialApp"><img src={logo} alt="" /></Link>
              <Link to="https://x.com/SocialApp_social"><img src={imgX} alt="" /></Link>
              <Link to="https://instagram.com/SocialApp_social"><InstagramIcon /></Link>
            </div>

            <div className="flex gap-3">
              <Link title="info@SocialApp.com" to="mailto:info@SocialApp.com">{t("Contato")}</Link>
