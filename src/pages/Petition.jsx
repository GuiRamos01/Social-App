  ...
  return (
    <aside id="Posts" className="Container ArticlePost noheaderMenu">
      ...
      {petition && petition.title && <Helmet>
        <title>{petition.title} - Petição / SocialApp</title>
      </Helmet>}
        ...
        <div id="Post">
          ...
          <div className="Petition">
            ...
            <div className="buttonShareX flex gap-3 mb-2">
              <Link target="_blank" to={`https://x.com/intent/post?url=https://SocialApp.com/go/${petition.shortLink}&text=${petition.title}%0A%0A`}>
                <img src={imgX} alt="" />
                {t("Compartilhar")}
              </Link>
            </div>
